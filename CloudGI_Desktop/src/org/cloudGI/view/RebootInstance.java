 ...
 */
public class RebootInstance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(20, 120, 132, 30);
        ...
        jTextField1.setBounds(220, 120, 227, 30);
        ...
        jLabel2.setText("Reiniciar Instância");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (JOptionPane.showConfirmDialog(null, "Tem certeza que deseja reiniar?", "Atenção", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            
           OpenStackCommands cos = new OpenStackCommands();
           boolean rei = cos.reboot(jTextField1.getText());
           if(rei){
               JOptionPane.showMessageDialog(null,"Instancia Reiniciada");
           }else{
               JOptionPane.showMessageDialog(null,"Instancia não Reiniciada");
           }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RebootInstance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RebootInstance().setVisible(true);
            }
        });
    }
