...
public class Terminal extends javax.swing.JFrame {
    ...
    public void showTerminal(String command) {

        jTextArea2.setText(jTextArea2.getText() + command + "\n");
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(0, 0, 1090, 650);

        setSize(new java.awt.Dimension(1109, 697));
